 ...
 * @return string
 */
function otgkofcs_get_request_string ($field, $default=null, $allow_tags = false) {
	if (!isset($_REQUEST[$field])) return $default;
	return otgkofcs_filter_string(wp_unslash($_REQUEST[$field]), false, $allow_tags, $default);
}
 ...
 * @return string|null
 */
function otgkofcs_get_request_texarea ($field, $default = null) {
	if (!isset($_REQUEST[$field])) return $default;
	return otgkofcs_filter_string(wp_unslash($_REQUEST[$field]), true, false, $default);
}
 ...
 * @return int|null
 */
function otgkofcs_get_request_int ($field, $default=null) {
	if (!isset($_REQUEST[$field])) return $default;
	return otgkofcs_filter_int_strict($_REQUEST[$field], $default);
}
 ...
 * @return float
 */
function otgkofcs_get_request_float ($field, $default = null) {
	if (!isset($_REQUEST[$field])) return $default;
	return otgkofcs_filter_float($_REQUEST[$field], $default);
}
 ...
 * @return string|null
 */
function otgkofcs_get_request_email ($field) {
	if (!isset($_REQUEST[$field])) return ['email' => '', 'valid' => false];
	return otgkofcs_filter_email($_REQUEST[$field]);
}
 ...
 * @return string|null
 */
function otgkofcs_get_request_link ($field, $default = null) {
	if (!isset($_REQUEST[$field])) return $default;
	return otgkofcs_filter_link($_REQUEST[$field]);
}
 ...
 * @return string|null
 */
function otgkofcs_get_request_boolean ($field, $default = null) {
	if (!isset($_REQUEST[$field])) return $default;
	return otgkofcs_filter_boolean ($_REQUEST[$field], $default);
}
 ...
 * @return array
 */
function otgkofcs_get_request_str_array ($field) {
	if (!isset($_REQUEST[$field])) return array();
	return otgkofcs_filter_str_array($_REQUEST[$field]);
}

/** Get the Bulk Action List and Only Allows Integers in the List
 * @return array
 */
function otgkofcs_get_request_int_array ($field = 'bulk_action_list') {
	if (!isset($_REQUEST[$field])) return array();
	return otgkofcs_filter_int_array($_REQUEST[$field]);
}
 ...
 * @return string
 */
function otgkofcs_filter_string ($in, $allow_new_line=false, $allow_tags=false, $default=null) {
	if ($allow_new_line)
 ...
 * @return array
 */
function otgkofcs_filter_str_array ($in) {
	$out = array();
 ...
 * @return array
 */
function otgkofcs_filter_email ($in) {
 ...
 * @return string|null
 */
function otgkofcs_filter_link ($in) {
	$link = trim($in);
 ...
 * @return int|null
 */
function otgkofcs_filter_int ($in) {
 ...
 * @return array
 */
function otgkofcs_filter_int_array ($in) {
	$out = array();
	if (!empty($in)) foreach ($in as $key => $value) {
 ...
 * @return int|null
 */
function otgkofcs_filter_int_strict ($in, $default=null) {
	if (0 === intval($in))
		return 0;
	$value = trim($in);
	if (empty($value))
 ...
 * @return array
 */
function otgkofcs_filter_int_strict_array ($in) {
	$out = array();
	if (!empty($in)) foreach ($in as $key => $value) {
 ...
 * @return float
 */
function otgkofcs_filter_float ($in, $default=null) {
 ...
 * @return string|null
 */
function otgkofcs_filter_boolean ($in, $default = null) {
